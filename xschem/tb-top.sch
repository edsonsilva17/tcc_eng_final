...
lab=GND}
N 2750 -1240 2750 -1190 {
lab=#net1}
N 2750 -1240 2770 -1240 {
lab=#net1}
N 3250 -1290 3330 -1290 {
lab=out1}
N 3100 -1240 3100 -1190 {
lab=#net2}
N 3070 -1240 3100 -1240 {
lab=#net2}
N 2620 -1290 2620 -1190 {
lab=#net3}
N 2620 -1290 2770 -1290 {
lab=#net3}
...
.endc
"}
C {devices/code.sym} 2410 -1230 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {devices/gnd.sym} 2620 -1090 0 0 {name=l7 lab=GND}
C {vsource.sym} 2620 -1160 0 0 {name=V1 value="sin (0 1 2.45E9)"}
...
C {top.sym} 2920 -1270 0 0 {name=x1}
